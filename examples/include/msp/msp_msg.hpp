...
enum class ID : uint16_t {
    ...
    MSP_MY_SET_CAM_CAP_DIMS            = 25,   // MY INS
    MSP_MY_SET_STRING1                 = 26,   // MY INS
...
// MSP_MY_SET_BBOX: 9
struct SetMyBbox : public MyBboxSettings, public Message {
    SetMyBbox(FirmwareVariant v) : Message(v) {}

    virtual ID id() const override { return ID::MSP_MY_SET_BBOX; }
...
// MSP_MY_SET_CAM_CAP_DIMS: 25
struct SetMyCamCapDims : public MyCamCapDims, public Message {
    SetMyCamCapDims(FirmwareVariant v) : Message(v) {}

    virtual ID id() const override { return ID::MSP_MY_SET_CAM_CAP_DIMS; }
...
// MSP_MY_SET_STRING1: 26
struct SetMyString1 : public MyString1, public Message {
    SetMyString1(FirmwareVariant v) : Message(v) {}

    virtual ID id() const override { return ID::MSP_MY_SET_STRING1; }
